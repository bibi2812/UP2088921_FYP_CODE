...
.method public a(Lz/h;Lz/i$d;)V
    ...
    invoke-static {v1}, Ly/i;->a(Ly/i;)Ly/i$h;
    ...
    invoke-static {v3, v2}, Lm/b;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :pswitch_0
    iget-object p1, p0, Ly/i$a;->a:Ly/i;

    invoke-static {p1}, Ly/i;->a(Ly/i;)Ly/i$h;

    move-result-object p1

    invoke-interface {p1}, Ly/i$h;->k()Z
    ...
    invoke-interface {v1, p1}, Ly/i$h;->i(Ljava/lang/String;)V

    :cond_2
    :goto_1
    invoke-interface {p2, v3}, Lz/i$d;->b(Ljava/lang/Object;)V
    ...
    :try_start_2
    invoke-static {p1}, Ly/i$e;->a(Ljava/lang/String;)Ly/i$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Lz/i$d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_3
    move-object p1, v3

    :goto_2
    iget-object v2, p0, Ly/i$a;->a:Ly/i;

    invoke-static {v2}, Ly/i;->a(Ly/i;)Ly/i$h;

    move-result-object v2

    invoke-interface {v2, p1}, Ly/i$h;->l(Ly/i$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p2, v2}, Lz/i$d;->b(Ljava/lang/Object;)V
    ...
    invoke-interface {p1}, Ly/i$h;->c()V
    :try_end_3
    ...
    invoke-static {v1, p1}, Ly/i;->f(Ly/i;Lorg/json/JSONObject;)Ly/i$j;
    ...
    invoke-interface {v1, p1}, Ly/i$h;->j(Ly/i$j;)V
    ...
    invoke-interface {p1}, Ly/i$h;->h()V
    ...
    invoke-interface {p1}, Ly/i$h;->a()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Ly/i;->e(Ly/i;Ljava/lang/String;)Ly/i$k;
    ...
    invoke-interface {v1, p1}, Ly/i$h;->f(Ly/i$k;)V
    ...
    invoke-static {v1, p1}, Ly/i;->d(Ly/i;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Ly/i$h;->g(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Ly/i;->c(Ly/i;Lorg/json/JSONObject;)Ly/i$c;
    ...
    invoke-interface {v1, p1}, Ly/i$h;->b(Ly/i$c;)V
    ...
    invoke-static {v1, p1}, Ly/i;->b(Ly/i;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Ly/i$h;->d(I)V
    ...
    invoke-static {p1}, Ly/i$g;->a(Ljava/lang/String;)Ly/i$g;
    ...
    invoke-interface {v1, p1}, Ly/i$h;->e(Ly/i$g;)V
    ...
    invoke-static {p1}, Ly/i$i;->a(Ljava/lang/String;)Ly/i$i;
    ...
    invoke-interface {v1, p1}, Ly/i$h;->m(Ly/i$i;)V
