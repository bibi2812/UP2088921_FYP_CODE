...
.field private deferredComponentManager:Lo/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lm/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ln/d;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Ln/d;->e(ILjava/nio/ByteBuffer;)V
...
.method public addIsDisplayingFlutterUiListener(Lx/b;)V
    .locals 1
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:La0/a;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:La0/a;

    invoke-virtual {p1, v0}, La0/a;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/k;->A()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public dispatchSemanticsAction(ILio/flutter/view/c$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lz/o;->b(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Ln/d;->b(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/k;->S(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/k;->T(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public removeIsDisplayingFlutterUiListener(Lx/b;)V
    .locals 1
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lo/a;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Lo/a;->b(ILjava/lang/String;)V
    ...
    invoke-static {p1, v0}, Lm/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setDeferredComponentManager(Lo/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lo/a;

    if-eqz p1, :cond_0

    invoke-interface {p1, p0}, Lo/a;->e(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(La0/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:La0/a;

    return-void
.end method

.method public setPlatformMessageHandler(Ln/d;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ln/d;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Le0/b;->a(ZLjava/lang/Object;)V
