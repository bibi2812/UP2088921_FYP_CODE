...
.field private d:Ly/i$j;

.field private e:I

.field final f:Ly/i$h;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Ly/i;Lio/flutter/plugin/platform/b$d;)V
    .locals 1
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/b;->f:Ly/i$h;

    iput-object p1, p0, Lio/flutter/plugin/platform/b;->a:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugin/platform/b;->b:Ly/i;

    invoke-virtual {p2, v0}, Ly/i;->l(Ly/i$h;)V
...
.method static synthetic a(Lio/flutter/plugin/platform/b;Ly/i$i;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/b;->q(Ly/i$i;)V
...
.method static synthetic e(Lio/flutter/plugin/platform/b;)Ly/i;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/b;->b:Ly/i;

    return-object p0
.end method

.method static synthetic f(Lio/flutter/plugin/platform/b;Ly/i$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/b;->u(Ly/i$c;)V
...
.method static synthetic h(Lio/flutter/plugin/platform/b;Ly/i$k;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/b;->w(Ly/i$k;)V
...
.method static synthetic k(Lio/flutter/plugin/platform/b;Ly/i$j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/b;->z(Ly/i$j;)V
...
.method static synthetic m(Lio/flutter/plugin/platform/b;Ly/i$e;)Ljava/lang/CharSequence;
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/b;->p(Ly/i$e;)Ljava/lang/CharSequence;
...
.method private p(Ly/i$e;)Ljava/lang/CharSequence;
    .locals 4
    ...
    sget-object v1, Ly/i$e;->b:Ly/i$e;
    ...
    invoke-static {v0, v1, p1}, Lm/b;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v2
.end method

.method private q(Ly/i$i;)V
    .locals 1

    sget-object v0, Ly/i$i;->b:Ly/i$i;
...
.method private r()V
    ...
    invoke-interface {v0}, Lio/flutter/plugin/platform/b$d;->c()Z
    ...
    invoke-interface {v0}, Landroidx/activity/b;->i()Landroidx/activity/OnBackPressedDispatcher;
...
.method private u(Ly/i$c;)V
    ...
    iget-object v4, p1, Ly/i$c;->b:Ljava/lang/String;

    const/4 v5, 0x0

    iget v6, p1, Ly/i$c;->a:I
    ...
    iget-object v1, p1, Ly/i$c;->b:Ljava/lang/String;

    const/4 v2, 0x0

    iget p1, p1, Ly/i$c;->a:I
...
.method private w(Ly/i$k;)V
    .locals 3

    sget-object v0, Ly/i$k;->b:Ly/i$k;
    ...
    :cond_0
    sget-object v0, Ly/i$k;->c:Ly/i$k;
    ...
    :cond_1
    sget-object v0, Ly/i$k;->d:Ly/i$k;
    ...
    :cond_2
    sget-object v0, Ly/i$k;->e:Ly/i$k;
    ...
    :cond_3
    :goto_0
    iput v1, p0, Lio/flutter/plugin/platform/b;->e:I
...
.method private z(Ly/i$j;)V
    ...
    invoke-direct {v2, v0, v1}, Ld/a;-><init>(Landroid/view/Window;Landroid/view/View;)V
    ...
    iget-object v6, p1, Ly/i$j;->b:Ly/i$d;
    ...
    :cond_0
    invoke-virtual {v2, v3}, Ld/a;->b(Z)V

    goto :goto_0

    :cond_1
    invoke-virtual {v2, v5}, Ld/a;->b(Z)V

    :cond_2
    :goto_0
    iget-object v6, p1, Ly/i$j;->a:Ljava/lang/Integer;
    ...
    :cond_3
    iget-object v6, p1, Ly/i$j;->c:Ljava/lang/Boolean;
    ...
    iget-object v6, p1, Ly/i$j;->e:Ly/i$d;
    ...
    :cond_6
    invoke-virtual {v2, v5}, Ld/a;->a(Z)V

    :cond_7
    :goto_1
    iget-object v2, p1, Ly/i$j;->d:Ljava/lang/Integer;
    ...
    :cond_8
    iget-object v2, p1, Ly/i$j;->f:Ljava/lang/Integer;
    ...
    :cond_9
    iget-object v2, p1, Ly/i$j;->g:Ljava/lang/Boolean;
    ...
    :cond_a
    iput-object p1, p0, Lio/flutter/plugin/platform/b;->d:Ly/i$j;
...
.method public A()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/b;->d:Ly/i$j;

    if-eqz v0, :cond_0

    invoke-direct {p0, v0}, Lio/flutter/plugin/platform/b;->z(Ly/i$j;)V
...
.method public o()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/b;->b:Ly/i;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ly/i;->l(Ly/i$h;)V
